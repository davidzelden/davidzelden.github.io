(function (window) {
    ...
    function init(game) {
        ...
        createCannon("top", 700); // a cannon on the top of the screen, located at x = 450
createCannon("left", 315, 1000); // a cannon on the left side of the screen, located at y = 300, with a 1 second delay (1000ms)
        // example: 
